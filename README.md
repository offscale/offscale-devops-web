...
First [`npm i -g angular-cli-ghpages`](https://github.com/angular-schule/angular-cli-ghpages), then:
    ...
    ng build --prod
    cp README.md dist/offscale-devops-web
    ngh -c offscale.io --dir='dist/offscale-devops-web' --repo=https://github.com/offscale/offscale.github.io --branch='master' --message='Using angular-cli-ghpages'
